...
# -*- coding: utf-8 -*-
#
# geoai-crop-health-classification documentation build configuration file, created by
# sphinx-quickstart.
#
...
htmlhelp_basename = 'GeoAI2025doc'
...
texinfo_documents = [
    ('index', 'GeoAI2025', u'geoai-crop-health-classification Documentation',
     u"Kaushal K", 'geoai-crop-health-classification',
